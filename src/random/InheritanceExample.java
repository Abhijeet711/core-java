...
public class InheritanceExample {
    public static void main(String[] args) {
        ...
        //here, as the object of cuboid is gretting created, you'll see in the output that the rectangle constructor getting called first and then the cuboid constructor. this is called constructor chaining. the compiler will always call parent class constructor and then child class constructor.
        cuboid c = new cuboid();
        c.length=5;
        c.breadth=4;
        c.height=3;
